export { type IModel } from "@sps/sps-crm/relations/widgets-to-request-blocks/sdk/model";
import { IModel } from "@sps/sps-crm/relations/widgets-to-request-blocks/sdk/model";
