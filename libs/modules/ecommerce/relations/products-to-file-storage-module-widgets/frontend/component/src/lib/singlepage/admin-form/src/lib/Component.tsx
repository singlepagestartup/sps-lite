...
import {
  variants,
  insertSchema,
} from "@sps/ecommerce/relations/products-to-file-storage-module-widgets/sdk/model";
import { api } from "@sps/ecommerce/relations/products-to-file-storage-module-widgets/sdk/client";
