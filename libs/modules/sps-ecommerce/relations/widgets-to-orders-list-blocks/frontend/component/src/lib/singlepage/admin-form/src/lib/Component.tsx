...
import { api } from "@sps/sps-ecommerce/relations/widgets-to-orders-list-blocks/sdk/client";
...
export function Component(props: IComponentPropsExtended) {
  ...
  const form = useForm<z.infer<typeof insertSchema>>({
    ...
    defaultValues: {
      ...
      ordersListBlockId: props.data?.ordersListBlockId || "",
    },
  });
    ...
    >
      <div className="flex flex-col gap-6">
        ...
        <OrdersListBlock
          ...
          hostUrl={props.hostUrl}
          variant="admin-select-input"
          formFieldName="ordersListBlockId"
          form={form}
        />
      </div>
    </ParentAdminForm>
