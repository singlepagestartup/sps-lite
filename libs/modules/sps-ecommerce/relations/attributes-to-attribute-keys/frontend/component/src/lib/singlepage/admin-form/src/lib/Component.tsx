...
import {
  variants,
  insertSchema,
} from "@sps/sps-ecommerce/relations/attributes-to-attribute-keys/sdk/model";
import { api } from "@sps/sps-ecommerce/relations/attributes-to-attribute-keys/sdk/client";
