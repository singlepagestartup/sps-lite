...
import { api } from "@sps/sps-ecommerce/relations/widgets-to-product-overview-blocks/sdk/client";
...
export function Component(props: IComponentPropsExtended) {
  ...
  const form = useForm<z.infer<typeof insertSchema>>({
    ...
    defaultValues: {
      ...
      productOverviewBlockId: props.data?.productOverviewBlockId || "",
    },
  });
    ...
    >
      <div className="flex flex-col gap-6">
        ...
        <ProductOverviewBlock
          ...
          hostUrl={props.hostUrl}
          variant="admin-select-input"
          formFieldName="productOverviewBlockId"
          form={form}
        />
      </div>
    </ParentAdminForm>
