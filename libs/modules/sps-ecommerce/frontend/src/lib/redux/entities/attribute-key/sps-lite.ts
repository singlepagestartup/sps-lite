...
import { populate } from "@sps/sps-ecommerce-contracts-extended/lib/models/attribute-key/populate";
import type { IEntity } from "@sps/sps-ecommerce-contracts-extended/lib/models/attribute-key/interfaces";
