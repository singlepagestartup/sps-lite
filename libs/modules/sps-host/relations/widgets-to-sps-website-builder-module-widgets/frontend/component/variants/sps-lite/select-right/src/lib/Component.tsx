...
import { api } from "@sps/sps-host-relations-widgets-to-sps-website-builder-module-widgets-frontend-api-client";
...
import { variants } from "@sps/sps-host-relations-widgets-to-sps-website-builder-module-widgets-contracts";

const formSchema = z.object({
  widgetId: z.string().min(1),
  spsWebsiteBuilderModuleWidgetId: z.string().min(1),
...
export function Component(props: IComponentPropsExtended) {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      spsWebsiteBuilderModuleWidgetId:
        props.data?.spsWebsiteBuilderModuleWidgetId,
  ...
  async function onSubmit(data: z.infer<typeof formSchema>) {
    if (!data.widgetId || !data.spsWebsiteBuilderModuleWidgetId) {
      return;
    }
      ...
      {props.data ? (
        ...
        >
          <div className="flex flex-col col-span-3 gap-0.5">
            ...
            <AdminSelectInput
              ...
              formFieldName="spsWebsiteBuilderModuleWidgetId"
            />
          </div>
        </ModelEntityCard>
      ) : (
        <Card className="overflow-hidden">
          <h3 className="admin-heading-h3 -mt-1 lg:-mt-2 -ml-0.5 lg:-ml-1 pb-4">
            Select entity from sps-website-builder-module-widgets
          </h3>
