...
import { api } from "@sps/sps-host/relations/pages-to-metadata/sdk/client";
...
import { Component as MetadataSelectInput } from "@sps/sps-host/models/metadata/frontend/component";
