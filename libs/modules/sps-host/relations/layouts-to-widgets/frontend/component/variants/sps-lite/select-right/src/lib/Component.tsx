...
import { Component as AdminSelectInput } from "@sps/sps-host-models-widget-frontend-component";
import { variants } from "@sps/sps-host-relations-layouts-to-widgets-contracts";
