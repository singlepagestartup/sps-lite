...
import { Component as AdminTable } from "@sps/sps-rbac-models-role-frontend-component-variants-sps-lite-admin-table";
import { Component as AdminSelectInput } from "@sps/sps-rbac-models-role-frontend-component-variants-sps-lite-admin-select-input";
