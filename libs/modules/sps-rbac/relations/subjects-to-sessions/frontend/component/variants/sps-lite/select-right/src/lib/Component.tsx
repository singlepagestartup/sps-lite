...
import { Component as AdminSelectInput } from "@sps/sps-rbac-models-session-frontend-component";
import { variants } from "@sps/sps-rbac-relations-subjects-to-sessions-contracts";
