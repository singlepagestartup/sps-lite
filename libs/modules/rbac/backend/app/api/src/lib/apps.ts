...
import { app as subjectsToEcommerceOrders } from "@sps/rbac/relations/subjects-to-ecommerce-orders/backend/app/root";
...
export class Apps {
  ...
  bindApps() {
    ...
    this.apps.push({
      type: "relation",
      route: "/subjects-to-ecommerce-orders",
      app: subjectsToEcommerceOrders,
    });
  }
}
