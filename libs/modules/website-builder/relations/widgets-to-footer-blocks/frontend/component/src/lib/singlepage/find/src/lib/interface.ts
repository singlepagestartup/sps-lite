export { type IModel } from "@sps/website-builder/relations/widgets-to-footer-blocks/sdk/model";
import { IModel } from "@sps/website-builder/relations/widgets-to-footer-blocks/sdk/model";
