...
import {
  variants,
  insertSchema,
} from "@sps/website-builder/relations/widgets-to-content-blocks/sdk/model";
import { api } from "@sps/website-builder/relations/widgets-to-content-blocks/sdk/client";
