...
import { Component as ContentBlocksToSpsFileStorageWidgets } from "@sps/website-builder/relations/content-blocks-to-file-storage-module-widgets/frontend/component";
