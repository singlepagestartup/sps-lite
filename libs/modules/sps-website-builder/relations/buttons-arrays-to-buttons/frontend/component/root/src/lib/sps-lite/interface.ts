import { IComponentProps as IFindComponentProps } from "@sps/sps-website-builder/relations/buttons-arrays-to-buttons/frontend/component/variants/sps-lite/find";
