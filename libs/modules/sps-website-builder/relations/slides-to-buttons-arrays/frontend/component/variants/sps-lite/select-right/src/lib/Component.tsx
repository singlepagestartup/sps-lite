...
import { api } from "@sps/sps-website-builder/relations/slides-to-buttons-arrays/frontend/api/client";
import { Component as AdminSelectInput } from "@sps/sps-website-builder/models/buttons-array/frontend/component/root";
import { variants } from "@sps/sps-website-builder/relations/slides-to-buttons-arrays/contracts/root";
...
export function Component(props: IComponentPropsExtended) {
  ...
  async function onSubmit(data: z.infer<typeof formSchema>) {
    if (!data.slideId || !data.buttonsArrayId) {
      return;
    }
  ...
  useActionTrigger({
    storeName: "sps-website-builder/slides",
    actionFilter: (action) => {
      return action.type === "slides/executeMutation/fulfilled";
    },
    callbackFunction: async (action) => {
      if (action.payload.id) {
        form.setValue("slideId", action.payload.id);
      }
