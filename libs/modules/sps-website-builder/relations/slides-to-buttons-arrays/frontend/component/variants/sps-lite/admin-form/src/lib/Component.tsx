...
import { route } from "@sps/sps-website-builder/relations/slides-to-buttons-arrays/frontend/api/model";
import {
  api,
  queryClient,
} from "@sps/sps-website-builder/relations/slides-to-buttons-arrays/frontend/api/client";
