...
import { api } from "@sps/sps-website-builder/relations/widgets-to-content-section-blocks/sdk/client";
...
import { Component as ContentSectionBlockAdminSelectInput } from "@sps/sps-website-builder/models/content-section-block/frontend/component";
...
export function Component(props: IComponentPropsExtended) {
  ...
  return (
    <ParentAdminForm<IModel, typeof variant>
      ...
      name="widgets-to-content-section-blocks"
      type="relation"
    >
      <div className="flex flex-col gap-6">
        ...
        <ContentSectionBlockAdminSelectInput
          isServer={props.isServer}
          hostUrl={props.hostUrl}
          variant="admin-select-input"
