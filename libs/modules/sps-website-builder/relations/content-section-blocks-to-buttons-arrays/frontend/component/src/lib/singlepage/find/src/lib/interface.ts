export { type IModel } from "@sps/sps-website-builder/relations/content-section-blocks-to-buttons-arrays/sdk/model";
import { IModel } from "@sps/sps-website-builder/relations/content-section-blocks-to-buttons-arrays/sdk/model";
