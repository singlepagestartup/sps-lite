...
import {
  variants,
  insertSchema,
} from "@sps/sps-website-builder/relations/content-section-blocks-to-buttons-arrays/sdk/model";
import { api } from "@sps/sps-website-builder/relations/content-section-blocks-to-buttons-arrays/sdk/client";
...
export function Component(props: IComponentPropsExtended) {
  ...
  return (
    <ParentAdminForm<IModel, typeof variant>
      ...
      name="content-section-blocks-to-buttons-arrays"
      type="relation"
    >
