...
import {
  variants,
  insertSchema,
} from "@sps/sps-website-builder/relations/content-blocks-to-buttons-arrays/sdk/model";
import { api } from "@sps/sps-website-builder/relations/content-blocks-to-buttons-arrays/sdk/client";
