...
import {
  variants,
  insertSchema,
} from "@sps/sps-website-builder/relations/content-blocks-to-sliders/sdk/model";
import { api } from "@sps/sps-website-builder/relations/content-blocks-to-sliders/sdk/client";
