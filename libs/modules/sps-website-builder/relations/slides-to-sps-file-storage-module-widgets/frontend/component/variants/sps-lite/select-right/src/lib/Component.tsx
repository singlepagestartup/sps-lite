...
import { variants } from "@sps/sps-website-builder-relations-slides-to-sps-file-storage-module-widgets-contracts";
...
export function Component(props: IComponentPropsExtended) {
  ...
  return (
    <div
      ...
      data-relation="slides-to-sps-file-storage-module-widgets"
