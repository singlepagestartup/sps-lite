...
import { Component as AdminSelectInput } from "@sps/sps-website-builder-models-metadata-frontend-component";
import { variants } from "@sps/sps-website-builder-relations-pages-to-metadata-contracts";
