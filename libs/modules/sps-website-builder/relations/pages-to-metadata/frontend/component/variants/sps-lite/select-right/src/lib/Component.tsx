...
import { api } from "@sps/sps-website-builder/relations/pages-to-metadata/frontend/api/client";
import { Component as AdminSelectInput } from "@sps/sps-website-builder/models/metadata/frontend/component/root";
import { variants } from "@sps/sps-website-builder/relations/pages-to-metadata/contracts/root";
...
export function Component(props: IComponentPropsExtended) {
  ...
  async function onSubmit(data: z.infer<typeof formSchema>) {
    if (!data.pageId || !data.metadataId) {
      return;
    }
  ...
  useActionTrigger({
    storeName: "sps-website-builder/page",
    actionFilter: (action) => {
