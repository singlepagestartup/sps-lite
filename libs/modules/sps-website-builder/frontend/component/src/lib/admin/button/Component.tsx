...
import { Component as ButtonsToSpsFileStorageModuleWidgets } from "@sps/sps-website-builder/relations/buttons-to-sps-file-storage-module-widgets/frontend/component";
