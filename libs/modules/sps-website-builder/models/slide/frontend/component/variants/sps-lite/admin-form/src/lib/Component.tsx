...
import { Component as AdminFormInputs } from "@sps/sps-website-builder-models-slide-frontend-component-variants-sps-lite-admin-form-inputs";
...
export function Component(props: IComponentPropsExtended) {
  ...
  useEffect(() => {
    if (updateEntityResult.data || createEntityResult.data) {
      dispatch(api.rtk.util.invalidateTags(["slide"]));
      invalidateServerTag({ tag: "slide" });
  ...
  return (
    ...
    >
      <Form {...form}>
        <Card>
          <CardHeader>
            <CardTitle>{props.data?.id ? "Edit" : "Create"} slide</CardTitle>
          </CardHeader>
