...
import { IComponentProps as IAdminFormInputsComponentProps } from "@sps/sps-website-builder/models/buttons-array/frontend/component/variants/sps-lite/admin-form-inputs";
