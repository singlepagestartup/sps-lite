 ...
 *
 * sps-website-builder
 * npx nx generate @sps/sps-generator-plugin:update --modules=sps-website-builder,startup,sps-file-storage,sps-rbac --right_external_models=sps-file-storage-widgets,sps-file-storage-module-widgets,sps-rbac-module-widgets,startup-module-widgets --no-interactive --dry-run
 *
 */
