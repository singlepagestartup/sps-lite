...
npx nx run sps-billing-backend:tsc:lib && echo yes | nx release prepatch && nx release publish && npm i sps-billing-plugin@latest @sps/shared-frontend-utils-server@latest @sps/shared-utils@latest
