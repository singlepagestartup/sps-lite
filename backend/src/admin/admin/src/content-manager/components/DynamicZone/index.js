...
import { getTrad } from "@strapi/admin/admin/src/content-manager/utils";

import connect from "@strapi/admin/admin/src/content-manager/components/DynamicZone/utils/connect";
import select from "@strapi/admin/admin/src/content-manager/components/DynamicZone/utils/select";

import DynamicZoneComponent from "@strapi/admin/admin/src/content-manager/components/DynamicZone/components/DynamicComponent";
import AddComponentButton from "@strapi/admin/admin/src/content-manager/components/DynamicZone/components/AddComponentButton";
import DynamicZoneLabel from "@strapi/admin/admin/src/content-manager/components/DynamicZone/components/DynamicZoneLabel";
import ComponentPicker from "@strapi/admin/admin/src/content-manager/components/DynamicZone/components/ComponentPicker";

import { useContentTypeLayout } from "@strapi/admin/admin/src/content-manager/hooks";
...
const DynamicZone = ({
  ...
  const handleClickOpenPicker = () => {
    if (dynamicDisplayedComponentsLength < max) {
      ...
      toggleNotification({
        type: "info",
        message: {
          id: getTrad("components.notification.info.maximum-requirement"),
        },
      });
    }
  };
  ...
  console.log("DynamicZone name", name);
      ...
      {dynamicDisplayedComponentsLength > 0 && (
        <Box>
          ...
          {dynamicDisplayedComponents.map((componentUid, index) => {
            const showDownIcon =
              isFieldAllowed && index < dynamicDisplayedComponentsLength - 1;
