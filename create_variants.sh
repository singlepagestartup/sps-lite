...
# move contracts
npx nx generate @nx/workspace:move --project=@sps/$module-$model_name-contracts --destination=libs/modules/sps-billing/models/invoice/contracts/root
npx nx generate @nx/workspace:move --project=@sps/$module-$model_name-contracts-extended --destination=libs/modules/sps-billing/models/invoice/contracts/extended
