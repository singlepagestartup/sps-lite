...
export const spsLiteBackendSlideOverRightSideHalfWidth: ISpsLiteBackendSlideOver =
  {
    id: 1,
    title: "Hello world",
    locale: "en",
...
export const spsLiteBackendSidebarOneQuarter: ISpsLiteBackendSidebar = {
  id: 1,
  title: "Ads sidebar",
  locale: "en",
  className: null,
...
export const spsLiteBackendNavbarBoxed: ISpsLiteBackendNavbar = {
  id: 1,
...
export const spsLiteBackendFooterBoxed: ISpsLiteBackendFooter = {
  id: 1,
...
export const spsLiteBackendLayoutWide: ISpsLiteBackendLayout = {
  id: 3,
  locale: "en",
  createdAt: "2023-03-28T11:07:56.252Z",
  updatedAt: "2023-03-28T11:07:57.474Z",
  ...
  variant: "wide",
  sidebar: spsLiteBackendSidebarOneQuarter,
  topbar: spsLiteBackendTopbarSimple,
  footer: spsLiteBackendFooterBoxed,
  navbar: spsLiteBackendNavbarBoxed,
  className: null,
};
