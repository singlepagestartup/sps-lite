import { ISpsLiteBackendTier } from "../interfaces/sps-lite";
import { entity as currency } from "~redux/services/backend/models/currency/mock/sps-lite";
...
export const entity: ISpsLiteBackendTier = {
  id: 1,
  title: "Lite",
