...
export default function ThreeColumnWithIllustrationsAndCenteredText(props: IIncentives) {
    return (
      <div className="bg-gray-50">
        <div className="mx-auto max-w-7xl py-24 sm:px-2 sm:py-32 lg:px-4">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-y-10 gap-x-8 px-4 lg:max-w-none lg:grid-cols-3">
            {props?.features.map((feature) => (
              <div key={feature.title} className="text-center sm:flex sm:text-left lg:block lg:text-center">
