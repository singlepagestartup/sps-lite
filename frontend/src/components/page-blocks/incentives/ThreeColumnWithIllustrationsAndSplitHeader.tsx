...
export default function ThreeColumnWithIllustrationsAndSplitHeader(props: IIncentives) {
    return (
          ...
          <div className="mx-auto max-w-2xl px-4 lg:max-w-none">
            ...
            <div className="mt-16 grid grid-cols-1 gap-y-10 gap-x-8 lg:grid-cols-3">
              {props?.features?.map((feature) => (
                <div key={feature.title} className="flex flex-col items-center sm:flex-row lg:block">
