DO $$ BEGIN
 CREATE TYPE "sps_website_builder_layouts_variant" AS ENUM('boxed', 'wide');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "sps_website_builder_pages_variant" AS ENUM('kudda', 'misd');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "sps_website_builder_layouts" (
	...
	"variant" "sps_website_builder_layouts_variant" DEFAULT 'wide' NOT NULL,
	"class_name" text,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
...
CREATE TABLE IF NOT EXISTS "sps_website_builder_pages" (
	...
	"variant" "sps_website_builder_pages_variant" DEFAULT 'kudda' NOT NULL,
